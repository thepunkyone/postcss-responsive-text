...
function test(fixture, opts, warnings, done) {
  ...
  postcss([plugin(opts)])
    .process(input, { from: `./fixtures/${input}` })
    .then((result) => {
...
describe('postcss-responsive-text', () => {
  ...
  describe('line height', () => {
    ...
    it('sets responsive line-height with extended syntax', (done) =>
    ...
    it('warns about responsive unitless line-height', (done) => {
      test('unitless_lineheight', {}, [], (error) => {
        expect(error).to.contain({
          ...
          plugin: 'postcss-responsive-text',
  ...
  describe('letterspacing', () => {
    ...
    it('sets responsive letterspacing with extended syntax', (done) =>
      test('letterspacing_extended', {}, [], done))

    it('sets responsive letterspacing with negative values', (done) =>
